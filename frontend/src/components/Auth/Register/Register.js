        ...
        >
          ...
          >
            ...
            >
              ...
              <Option value="medical_owner">Medical Owner</Option>
            </Select>
          </Form.Item>
          ...
          {role === 'medical_owner' && (
            <Row gutter={16}>
              ...
              <Col xs={24}>
                ...
                >
                  <TextArea prefix={<HomeOutlined />} placeholder="Business Address" rows={3} />
                </Form.Item>
              </Col>
              <Col xs={24} sm={12}>
                <Form.Item
                  ...
                  rules={[
                    { 
                      required: true, 
                      message: 'Please input your business license number!' 
                    },
                    {
                      max: 50,
                ...
                >
                  <Input placeholder="Business License Number" size="large" />
                </Form.Item>
              </Col>
              <Col xs={24} sm={12}>
                <Form.Item
                ...
                >
                  <Input placeholder="Tax ID Number" size="large" />
                </Form.Item>
              </Col>
            </Row>
          )}
